const checkLogoTemplate = document.createElement('template')
checkLogoTemplate.innerHTML = `
<?xml version="1.0" encoding="UTF-8"?>
<svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 708.49 1020.38" height="100" width="100">
  <defs>
    <style>
      .cls-1 {
        fill: #fc9aa7;
...
class CheckLogo extends HTMLElement {
  constructor() {
    super()
    this.attachShadow({ mode: 'open' })
    this.shadowRoot.appendChild(checkLogoTemplate.content.cloneNode(true))
  }
}

customElements.define('check-logo', CheckLogo)
